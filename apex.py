...
from utils import resource_path  # <-- tu función resource_path que maneja rutas dentro del exe
...
def iniciar_bot(usuario, password, textbox):
    ...
    Args:
        ...
        textbox (CTkTextbox): Textbox de Tkinter para logs y plantilla.
    """
    ...
    # Usa webdriver_manager para no depender de chromedriver externo
    ...
    # -------------------------
    # Funciones de procesamiento de plantilla
    # -------------------------
    ...
    def on_enter(event=None):
        ...
        if plantilla:
            threading.Thread(target=procesar_plantilla, args=(plantilla,)).start()
