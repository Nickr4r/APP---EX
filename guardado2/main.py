...
# Intento de importar la lógica del bot
try:
...
class App(ctk.CTk):
    def __init__(self):
        ...
        # --- LOGO ---
        self.logo_path_png = "nick.png"
        self.logo_path_ico = "nick.ico"
        try:
            self.iconbitmap(self.logo_path_ico)
        except Exception as e:
            print(f"No se pudo cargar el icono de la ventana/barra de tareas: {e}")
        ...
        try:
            ...
            print(f"No se encontró {self.logo_path_png} para la barra lateral: {e}")

        self.logo_label = ctk.CTkLabel(
            self.sidebar_frame, text="BOT CAT",
        ...
        self.btn_login = ctk.CTkButton(
            self.sidebar_frame, text="Login", height=35,
        ...
        self.btn_plantilla = ctk.CTkButton(
            self.sidebar_frame, text="Plantilla", height=35,
            fg_color="transparent", text_color=self.text_color,
            hover_color=("#EAEAEA", "#2B2B2B"), anchor="w",
    ...
    def setup_login_view(self):
        ...
        self.login_card = ctk.CTkFrame(
            self.login_view, corner_radius=20,
        ...
        ctk.CTkLabel(
            self.login_card, text="ACCESO AL SISTEMA",
            font=ctk.CTkFont(size=16, weight="bold"),
            text_color=self.text_color
        ).pack(pady=(40, 25), padx=60)

        self.usuario_entry = ctk.CTkEntry(
            self.login_card, width=260, placeholder_text="Usuario",
        ...
        self.pass_entry = ctk.CTkEntry(
            self.login_card, width=260, placeholder_text="Contraseña",
            height=42, fg_color=self.bg_color_total,
            border_width=1, text_color=self.text_color
        )
        ...
        self.boton_login = ctk.CTkButton(
            self.login_card, text="INICIAR BOT",
    ...
    def setup_plantilla_view(self):
        ...
        self.textbox = ctk.CTkTextbox(
            self.plantilla_view, corner_radius=12, border_width=2,
        ...
        self.info_panel = ctk.CTkFrame(
            self.plantilla_view, width=250, corner_radius=12,
            fg_color=self.frame_bg, border_width=2, border_color=self.border_color
        )
        ...
        ctk.CTkLabel(
            self.info_panel, text="INSTRUCCIONES",
            font=ctk.CTkFont(size=13, weight="bold"),
            text_color=self.text_color
        ).pack(pady=(20, 10))

        ctk.CTkLabel(
            self.info_panel, text="Pega la siguiente plantilla:",
        ...
        ctk.CTkLabel(
            self.info_panel, text=plantilla_ejemplo,
    ...
    def ejecutar_bot(self):
        ...
        hilo = threading.Thread(target=iniciar_bot, args=(usuario, password, self.textbox))
        hilo.start()
